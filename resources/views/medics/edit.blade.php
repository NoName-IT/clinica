            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">@lang('general.edit_medic')</li>
                    </ol>
                </div>

                <div class="panel-body">

                   	<form class="form-horizontal" role="form" method="POST" action="{{ URL::route('medics.update', $medic) }}">
                        ...
                        <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="first_name" type="text" class="form-control" name="first_name" value="{{ $medic->first_name }}">
                        ...
                        <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="last_name" type="text" class="form-control" name="last_name" value="{{ $medic->last_name }}">
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control selectpicker show-tick" name="blood_type">
                                    ...
                                    @foreach($blood_types as $blood_type)
                                        ...
                                        {{ ($medic->blood_type->id == $blood_type->id ? "selected":"") }}
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control selectpicker show-tick" name="medic_type">
                                    ...
                                    @foreach($medic_types as $medic_type)
                                        ...
                                        {{ ($medic->medic_type->id == $medic_type->id ? "selected":"") }}
                        ...
                        <div class="form-group{{ $errors->has('cuit') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-4">
                                    <input id="cuit" type="text" class="form-control" name="cuit" value="{{ $medic->cuit }}">
                         ...
                         <div class="form-group{{ $errors->has('dni') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-4">
                                    <input id="dni" type="text" class="form-control" name="dni" value="{{ $medic->dni }}">
                         ...
                         <div class="form-group{{ $errors->has('license') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-4">
                                    <input id="license" type="text" class="form-control" name="license" value="{{ $medic->license }}">
                        ...
                        <div class="form-group{{ $errors->has('street_address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-4">
                                    <input id="street_address" type="text" class="form-control" name="street_address" value="{{ $medic->street_address }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-user"></i> @lang('general.edit_medic')
                                </button>
                            </div>
                        </div>
