            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo app('translator')->get('general.create_discharge_type'); ?></li>
                    </ol>
                </div>
                ...
                <div class="panel-body">
                	...
                	<form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/admin/discharge_types')); ?>">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-user"></i> <?php echo app('translator')->get('general.create_discharge_type'); ?>
                                </button>
                            </div>
                        </div>
                    </form>
