...
<head>
    ...
    <link rel="stylesheet" href="{!! asset('bower_components/dropzone/dropzone.min.css') !!}" />
    <link rel="stylesheet" href="{!! asset('bower_components/dropzone/basic.min.css') !!}" />
    ...
    <script src="{!! asset('bower_components/dropzone/dropzone-amd-module.min.js') !!}" defer></script>
    <script src="{!! asset('bower_components/dropzone/dropzone.min.js') !!}" defer></script>
