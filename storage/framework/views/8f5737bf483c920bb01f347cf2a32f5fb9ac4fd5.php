            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo app('translator')->get('general.create_internment'); ?></li>
                    </ol>
                </div>
                            ...
                            <div class="col-md-6 col-md-offset-4">
                              <a  class="btn btn-warning" href="<?php echo e(URL::previous()); ?>"> <i class="fa fa-btn fa-undo" ></i> <?php echo app('translator')->get('general.cancel_button'); ?></a>
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-user"></i> <?php echo app('translator')->get('internment.create_patient'); ?>
                                </button>
