        ...
        <div class="col-md-12">
            <div class="panel panel-default">
               <div class="panel-heading">
                    <ol class="breadcrumb">
                    	<li><a href="<?php echo e(url('/coinsurances')); ?>"><?php echo app('translator')->get('general.coinsurances'); ?></a></li>
                        <li class="active"><?php echo app('translator')->get('general.create_coinsurance'); ?></li>
                    </ol>
                </div>

                <div class="panel-body">

                   	<form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/coinsurances')); ?>">
                        <?php echo e(csrf_field()); ?>


                        <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                                <label for="name" class="col-md-4 control-label"><?php echo app('translator')->get('coinsurance.name'); ?></label>
                        ...
                        <div class="form-group<?php echo e($errors->has('affiliate_type') ? ' has-error' : ''); ?>">
                            <label for="affiliate_type" class="col-md-4 control-label"><?php echo app('translator')->get('coinsurance.affiliate_type'); ?></label>
                        ...
                        <div class="form-group<?php echo e($errors->has('module') ? ' has-error' : ''); ?>">
                            <label for="module" class="col-md-4 control-label"><?php echo app('translator')->get('coinsurance.module'); ?></label>
                        ...
                        <div class="form-group<?php echo e($errors->has('available_days') ? ' has-error' : ''); ?>">
                                <label for="available_days" class="col-md-4 control-label"><?php echo app('translator')->get('coinsurance.available_days'); ?></label>
                         ...
                         <div class="form-group<?php echo e($errors->has('renovation_days') ? ' has-error' : ''); ?>">
                                <label for="renovation_days" class="col-md-4 control-label"><?php echo app('translator')->get('coinsurance.renovation_days'); ?></label>
                        ...
                        <div class="form-group<?php echo e($errors->has('price_per_day') ? ' has-error' : ''); ?>">
                                <label for="price_per_day" class="col-md-4 control-label"><?php echo app('translator')->get('coinsurance.price_per_day'); ?></label>
                        ...
                        <div class="form-group<?php echo e($errors->has('coverage') ? ' has-error' : ''); ?>">
                                <label for="coverage" class="col-md-4 control-label"><?php echo app('translator')->get('coinsurance.coverage'); ?></label>
                        ...
                        <div class="form-group<?php echo e($errors->has('iva') ? ' has-error' : ''); ?>">
                                <label for="iva" class="col-md-4 control-label"><?php echo app('translator')->get('coinsurance.iva'); ?></label>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-user"></i> <?php echo app('translator')->get('coinsurance.create_coinsurance'); ?>
                                </button>
                            </div>
                        </div>
