            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">@lang('general.create_coinsurance')</li>
                    </ol>
                </div>

                <div class="panel-body">

                   	<form class="form-horizontal" role="form" method="POST" action="{{ url('/coinsurances') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-user"></i> @lang('coinsurance.create_coinsurance')
                                </button>
                            </div>
                        </div>
