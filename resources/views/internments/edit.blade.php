                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group{{ $errors->has('room') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <input id="room" type="text" class="form-control" name="room" value="{{ $internment->room }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group{{ $errors->has('clinic_history') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="clinic_history" type="text" class="form-control" name="clinic_history" value="{{ $internment->clinic_history }}">
