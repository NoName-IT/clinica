            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">@lang('general.create_medical_insurance')</li>
                    </ol>
                </div>

                <div class="panel-body">

                   	<form class="form-horizontal" role="form" method="POST" action="{{ url('/medical_insurances') }}">
                        {{ csrf_field() }}
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control selectpicker show-tick" name="affiliate_type">
                                    ...
                                    @foreach($affiliate_types as $affiliate_type)
                                        ...
                                        {{ (old("affiliate_type") == $affiliate_type ? "selected":"") }}
                        ...
                        <div class="form-group{{ $errors->has('available_days') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-2">
                                    <input id="available_days" type="text" class="form-control" name="available_days" value="{{ old('available_days') }}">
                         ...
                         <div class="form-group{{ $errors->has('renovation_days') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-2">
                                    <input id="renovation_days" type="text" class="form-control" name="renovation_days" value="{{ old('renovation_days') }}">
                        ...
                        <div class="form-group{{ $errors->has('coverage') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-2">
                                    <input id="coverage" type="text" class="form-control" name="coverage" value="{{ old('coverage') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-user"></i> @lang('general.create_medical_insurance')
                                </button>
                            </div>
                        </div>
