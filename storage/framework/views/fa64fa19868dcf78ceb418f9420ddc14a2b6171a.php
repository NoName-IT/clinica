            ...
            <div class="panel panel-default">
               <div class="panel-heading">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo app('translator')->get('general.edit_patient'); ?></li>
                    </ol>
                </div>
                <div class="panel-body">
                   
                   	<form class="form-horizontal" role="form" method="POST" action="<?php echo e(URL::route('patients.update', $patient)); ?>">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group<?php echo e($errors->has('first_name') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-8">
                                    <input id="first_name" type="text" class="form-control" name="first_name" value="<?php echo e($patient->first_name); ?>">
                            ...
                            <div class="col-md-6 form-group<?php echo e($errors->has('last_name') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-8">
                                    <input id="last_name" type="text" class="form-control" name="last_name" value="<?php echo e($patient->last_name); ?>">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group<?php echo e($errors->has('town') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input id="town_text" placeholder="<?php echo app('translator')->get('general.find_town'); ?>" class="form-control" name="town_text" type="text" value="<?php echo e($town['value']); ?>">

                                    <input id="town" placeholder="" name="town" type="text" value="<?php echo e($town['id']); ?>" hidden>
                            ...
                            <div class="col-md-6 form-group<?php echo e($errors->has('birth_town') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input id="birth_town_text" placeholder="<?php echo app('translator')->get('general.find_town'); ?>" class="form-control" name="birth_town_text" type="text" value="<?php echo e($birth_town['value']); ?>">

                                    <input id="birth_town" placeholder="" name="birth_town" type="text" value="<?php echo e($birth_town['id']); ?>" hidden>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group<?php echo e($errors->has('birth_date') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="birth_date" type="text" class="form-control" name="birth_date" value="<?php echo e($patient->birth_date); ?>">
                            ...
                            <div class="col-md-6 form-group<?php echo e($errors->has('birth_time') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="birth_time" type="text" class="form-control" name="birth_time" value="<?php echo e($patient->birth_time); ?>">
                                ...
                                <select class="form-control selectpicker show-tick" name="civil_status">
                                    ...
                                    <?php foreach($civil_statuses as $civil_status): ?>
                                        ...
                                        <option value="<?php echo e($civil_status->id); ?>" 
                                            <?php if($civil_status->id == $patient->civil_status_id): ?>
                                                selected
                                            <?php endif; ?>
                                            ><?php echo e($civil_status->name); ?>
                                ...
                                <select class="form-control selectpicker show-tick" name="blood_type">
                                    ...
                                    <?php foreach($blood_types as $blood_type): ?>
                                        ...
                                        <option value="<?php echo e($blood_type->id); ?>" 
                                            <?php if($blood_type->id == $patient->blood_type_id): ?>
                                                selected
                                            <?php endif; ?>
                                            ><?php echo e($blood_type->name); ?>
                                ...
                                <select class="form-control selectpicker show-tick" name="dni_type">
                                    ...
                                    <?php foreach($dni_types as $dni_type): ?>
                                        ...
                                        <option value="<?php echo e($dni_type->id); ?>" 
                                            <?php if($dni_type->id == $patient->dni_type_id): ?>
                                                selected
                                            <?php endif; ?>
                                            ><?php echo e($dni_type->name); ?>
                        ...
                        <div class="col-md-4 form-group<?php echo e($errors->has('dni') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-8">
                                    <input id="dni" type="text" class="form-control" name="dni" value="<?php echo e($patient->dni); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group<?php echo e($errors->has('street_address') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="street_address" type="text" class="form-control" name="street_address" value="<?php echo e($patient->street_address); ?>">
                            ...
                            <div class="col-md-6 form-group<?php echo e($errors->has('phone') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-8">
                                        <input id="phone" type="text" class="form-control" name="phone" value="<?php echo e($patient->phone); ?>">
                        ...
                        <div class="col-md-6 form-group<?php echo e($errors->has('medical_insurance') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control selectpicker show-tick" name="medical_insurance" data-live-search="true">
                                    <option value=""
                                    <?php if(is_null($medical_insurance_patient)): ?>
                                         selected
                                    <?php endif; ?>
                                    ...
                                    <?php foreach($medical_insurances as $medical_insurance): ?>
                                        ...
                                        <?php if(! is_null($medical_insurance_patient)): ?>
                                            <?php if($medical_insurance->id == $medical_insurance_patient->id): ?>
                                                selected
                                            <?php endif; ?>
                                        <?php endif; ?>
                 ...
                 <div class="col-md-6 form-group<?php echo e($errors->has('mi_affiliate_number') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php if($medical_insurance_patient): ?>
                                            value="<?php echo e($medical_insurance_patient->pivot->affiliate_number); ?>"
                                        <?php else: ?>
                                            value=""
                                        <?php endif; ?>
                                        >
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-6 form-group<?php echo e($errors->has('coinsurance') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control selectpicker show-tick" name="coinsurance" data-live-search="true">
                                    ...
                                    <?php if(is_null($coinsurance_patient)): ?>
                                         selected
                                    <?php endif; ?>
                                    ...
                                    <?php foreach($coinsurances as $coinsurance): ?>
                                        ...
                                        <?php if(! is_null($coinsurance_patient)): ?>
                                            ...
                                            <?php if($coinsurance->id == $coinsurance_patient->id): ?>
                                                selected
                                            <?php endif; ?>
                                        <?php endif; ?>
                    ...
                    <div class="col-md-6 form-group<?php echo e($errors->has('c_affiliate_number') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php if($coinsurance_patient): ?>
                                            value="<?php echo e($coinsurance_patient->pivot->affiliate_number); ?>"
                                        <?php else: ?>
                                            value=""
                                        <?php endif; ?>
                                        >
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-user"></i> <?php echo app('translator')->get('general.edit_patient'); ?>
                                </button>
